...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, firstName: $firstName, lastName: $lastName, name: $name, createdAt: $createdAt, isEmailVerified: $isEmailVerified, phoneNumber: $phoneNumber, isAdmin: $isAdmin, lastLogin: $lastLogin, dateJoined: $dateJoined)';
  }
